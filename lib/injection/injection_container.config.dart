...
import '../interfaces/socket_handler_interface.dart' as _i13;
...
import '../sdk_core.dart' as _i12;
import '../services/callkit/callkit_listener.dart' as _i11;
import '../services/socket/socket_emiter.dart' as _i6;
import '../services/socket/socket_handler.dart' as _i14;
...
_i1.GetIt $initGetIt(
  ...
  gh.singleton<_i11.CallKitListener>(_i11.CallKitListener(
    gh<_i7.WaterbusLogger>(),
    gh<_i9.WaterbusWebRTCManager>(),
  ));
  gh.singleton<_i12.SdkCore>(_i12.SdkCore(
    gh<_i9.WaterbusWebRTCManager>(),
    gh<_i4.ReplayKitChannel>(),
    gh<_i7.WaterbusLogger>(),
  ));
  gh.singleton<_i13.SocketHandler>(_i14.SocketHandlerImpl(
    gh<_i9.WaterbusWebRTCManager>(),
    gh<_i7.WaterbusLogger>(),
  ));
  return getIt;

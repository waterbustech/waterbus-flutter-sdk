...
import '../core/api/user/repositories/user_repository.dart' as _i24;
...
import '../core/websocket/interfaces/socket_handler_interface.dart' as _i19;
import '../core/websocket/socket_emiter.dart' as _i9;
import '../core/websocket/socket_handler.dart' as _i20;
...
_i1.GetIt $initGetIt(
  ...
  gh.singleton<_i19.SocketHandler>(() => _i20.SocketHandlerImpl(
        gh<_i13.WaterbusWebRTCManager>(),
        gh<_i4.WaterbusLogger>(),
        gh<_i10.AuthLocalDataSource>(),
      ));
  ...
  gh.lazySingleton<_i24.UserRepository>(
      () => _i24.UserRepositoryImpl(gh<_i15.UserRemoteDataSource>()));
  gh.singleton<_i25.WaterbusSdkInterface>(() => _i26.SdkCore(
        gh<_i19.SocketHandler>(),
        gh<_i13.WaterbusWebRTCManager>(),
        gh<_i5.ReplayKitChannel>(),
        gh<_i4.WaterbusLogger>(),
